...
@InputType()
class FavoriteCarParkCreateNestedManyWithoutCarParksInput {
...
export { FavoriteCarParkCreateNestedManyWithoutCarParksInput as FavoriteCarParkCreateNestedManyWithoutCarParksInput };
