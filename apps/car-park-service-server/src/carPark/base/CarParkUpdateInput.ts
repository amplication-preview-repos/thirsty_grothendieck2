...
class CarParkUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FavoriteCarParkUpdateManyWithoutCarParksInput,
  })
  @ValidateNested()
  @Type(() => FavoriteCarParkUpdateManyWithoutCarParksInput)
  @IsOptional()
  @Field(() => FavoriteCarParkUpdateManyWithoutCarParksInput, {
    nullable: true,
  })
  favoriteCarParks?: FavoriteCarParkUpdateManyWithoutCarParksInput;
}

export { CarParkUpdateInput as CarParkUpdateInput };
